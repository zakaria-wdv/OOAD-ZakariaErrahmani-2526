...
// afspraak classe - een rij in de afspraak tabel
...
public class Afspraak
{
    ...
    // foreign keys naar de gekoppelde patient en dokter
    ...
    public static List<Afspraak> GeefAfsprakenVoorDokterOpDag(int dokterId, DateTime datum)
    {
        ...
        using (SqlConnection conn = Database.GetConnection())
        {
            ...
            // een JOIN met patient om de naam direct mee op te halen
    ...
    // CRUD - read by patient: alle afspraken voor een patient (met dokter info)
    ...
    // CRUD - create: nieuwe afspraak in db
    ...
    // CRUD - delete: verwijdert een afspraak uit db
