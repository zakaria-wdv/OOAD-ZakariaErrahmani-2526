...
namespace WpfEscapeGame.Classes
{
    public static class RandomMessageGenerator
    {
        ...
        public static string GetRandomMessage(WpfEscapeGame.Enums.MessageType t)
        {
            return t switch
            {
                WpfEscapeGame.Enums.MessageType.ItemDoesNotFit => _itemDoesNotFit[_rnd.Next(_itemDoesNotFit.Length)],
                WpfEscapeGame.Enums.MessageType.ItemNotPortable => _itemNotPortable[_rnd.Next(_itemNotPortable.Length)],
                WpfEscapeGame.Enums.MessageType.DoorWrongKey => _doorWrongKey[_rnd.Next(_doorWrongKey.Length)],
